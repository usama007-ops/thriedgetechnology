...
function ShareButtons({ title }: { title: string }) {
  ...
  return (
    <div className={cn('flex', 'items-center', 'gap-[8px]', 'flex-wrap')}>
      ...
      <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(url)}`}
        ...
        className={cn('flex', 'items-center', 'gap-[6px]', 'text-[12px]', 'font-inter', 'text-[#555]', 'border', 'border-[#E5E4E0]', 'px-[10px]', 'py-[6px]', 'rounded-full', 'hover:border-black', 'hover:text-black', 'transition-colors', 'duration-200')}>

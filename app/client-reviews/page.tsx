...
export default async function ClientReviewsPage() {
  ...
  return (
    <div className="relative bg-white">
          ...
          <div className="gap-[1px] grid grid-cols-2 md:grid-cols-4 bg-[#e5e5e5] rounded-[16px] overflow-hidden">
            {[
              ...
              <Animate key={s.label} variant="scale-in" delay={i * 80}>
                <div className="flex flex-col gap-[4px] bg-white px-[28px] py-[28px]">
      ...
      <Animate variant="fade-up" className="flex justify-center mx-auto px-[16px] md:px-[36px] pb-[32px] md:pb-[64px] w-full max-w-[1440px]">
            ...
            {testimonials.map((t, i) => {
              ...
              return (
                <Animate key={t.id} variant="fade-up" delay={(i % 3) * 100}>
                  <div className="flex flex-col gap-[20px] bg-white hover:shadow-lg p-[28px] border border-[#e5e5e5] hover:border-[#111212] rounded-[20px] transition-all duration-300">

...
const FAQS = [
  ...
  { topic: 'Partnership Basics', q: 'Who owns the code and IP at the end of a project?', a: 'You retain full ownership of all code, designs, and project assets once the engagement is completed. We do not claim any rights over your intellectual property or deliverables.' },

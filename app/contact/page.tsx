    ...
    <div className="bg-[#F3F3F3] min-h-screen">
      ...
      <section className="mx-auto px-5 lg:px-9 pt-20 pb-10 lg:py-20 max-w-[1440px]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          {/* Left Column */}
          <Animate variant="slide-left" className="flex flex-col gap-8 w-full">
            <div className="flex flex-col gap-4">
              ...
              <p className="font-inter text-[14px] text-[#929296] leading-[1.7]">
                Describe your product, timeline, and key requirements. A senior
                member of our team will review your submission and reply with a
                clear next step.
              </p>
            ...
            <Animate variant="fade-up" delay={120}>
              <div className="bg-white border border-[#e5e5e5] rounded-[16px] p-5 flex flex-col gap-4">
                <div className="flex flex-col gap-0.5">
                  <span className="font-mont font-semibold text-[14px] text-[#111212]">
                    Anthony Price
                  </span>
                  <div className="flex items-center gap-2">
                    <span className="font-inter text-[12px] text-[#929296]">
                      Acorn PG
                    </span>
                    <span className="bg-[#111212] text-white font-inter text-[10px] px-2 py-0.5 rounded-full">
                      Managing Director
                    </span>
                  </div>
                </div>
                <p className="font-inter text-[13px] text-[#555] leading-[1.7]">
                  &ldquo;They handled complex projects with professionalism and
                  clarity. Every milestone was delivered on time and the
                  communication throughout was excellent.&rdquo;
                </p>
              </div>
            </Animate>
            ...
            <Animate variant="fade-up" delay={200}>
              <div className="flex items-center gap-2 mt-2">
                <span className="font-inter text-[13px] text-[#929296]">
                  Prefer messaging?
                </span>
                <a
          ...
          <Animate variant="slide-right" delay={80} className="w-full min-w-0">
            <MeetingBooker />
          </Animate>
        </div>
      </section>

  ...
  return (
    <div className="relative bg-white">
      ...
      <div className="flex md:flex-row flex-col items-start gap-[64px] mx-auto px-[16px] md:px-[36px] pb-[96px] w-full max-w-[1440px]">
        ...
        <Animate variant="fade-up" className="flex-1 min-w-0">
          <div className="flex-1 min-w-0">
            {job.content?.rendered ? (
              <div className="job-content" dangerouslySetInnerHTML={{ __html: job.content.rendered }} />
            ) : (
        ...
        {/* Sidebar */}
        <Animate variant="slide-right" delay={120} className="md:top-[100px] md:sticky flex flex-col gap-[24px] w-full md:w-[300px] shrink-0">

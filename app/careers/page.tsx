...
export default function CareersPage() {
  ...
  const filtered =
    activeDept === "All"
      ? jobs
      : jobs.filter(
          (j) => (j.department?.[0]?.name ?? "General") === activeDept,
        );
    ...
    <div className="bg-white">
      ...
      >
        <div className={cn("mx-auto", "px-4", "md:px-9", "max-w-360")}>
          <div
            className={cn("flex", "gap-0", "overflow-x-auto", "no-scrollbar")}
          >
            {depts.map((dept) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[11px] font-inter px-1.75 py-0.5 rounded-full ${isActive ? "bg-[#111212] text-white" : "bg-[#f3f3f3] text-[#929296]"}`}
                  >
                    {count}
                  </span>
                </button>
      ...
      {/* Job list */}
      <div className={cn("mx-auto", "px-4", "md:px-9", "pt-16", "max-w-360")}>
        {shown.length > 0 ? (
          <div className={cn("flex", "flex-col", "gap-0")}>
            {shown.map((job, idx) => {
              ...
              const excerpt =
                job.content?.rendered?.replace(/<[^>]*>/g, "").slice(0, 120) ??
                "";
              return (
          ...
          <Animate variant="fade-in">
            ...
            >
              ...
              <p className={cn("font-inter", "text-[#929296]", "text-[14px]")}>
